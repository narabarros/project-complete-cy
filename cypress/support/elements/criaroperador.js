export const ELEMENTS_CRIAROPERADOR = {
    ...
    txtEmail: '[data-test="company-modal-user-input-email"]',
    txtNomeExibicao: '[data-test="company-modal-user-input-display_name"]',
    txtSenha: '[data-test="company-modal-user-input-password"]',
    btnFeminino: '[data-test="company-modal-user-input-female"]',
